...
DeckModel _$DeckModelFromJson(Map<String, dynamic> json) => DeckModel(
      ...
      studyMode: $enumDecodeNullable(_$StudyModeEnumMap, json['study_mode']) ??
      ...
      totalStudyTime: json['total_study_time'] == null
          ? Duration.zero
          : Duration(microseconds: (json['total_study_time'] as num).toInt()),
...
Map<String, dynamic> _$DeckModelToJson(DeckModel instance) => <String, dynamic>{
      ...
      'mastered_cards': instance.masteredCards,
      'average_score': instance.averageScore,
      'total_study_time': instance.totalStudyTime.inMicroseconds,
      ...
      'source_file_url': instance.sourceFileUrl,
